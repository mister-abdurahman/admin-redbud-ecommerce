...
function CategoryRow({ category }: { category: ICategory }) {
  ...
  const { id: categoryId, name, description, created_at } = category;
      ...
      <Modal>
        ...
        {/* <Modal.Window name={"delete"}>
          <ConfirmDelete
            ...
            extraInfo="Note that deleting this category deletes any product under it, ⚠ deleting should be avoided at all cost."
          />
        </Modal.Window> */}
      </Modal>
    </Table.Row>
